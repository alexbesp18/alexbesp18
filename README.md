...
I build governed AI/data platforms for operating teams; the one-person, AI-operated equity
research desk below is the proving ground. These repos are its organs, extracted from the systems
that actually run — each README says what the private original does daily, and each demo shows
the engineering, keyless, in about 90 seconds.
